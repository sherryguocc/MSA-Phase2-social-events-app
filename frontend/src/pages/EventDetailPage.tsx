      ...
      <div className="max-w-4xl mx-2 sm:mx-4 lg:mx-auto mt-4 sm:mt-8 p-3 sm:p-6 lg:p-8 bg-white rounded-xl sm:rounded-2xl shadow-lg overflow-hidden">
        ...
        <div className="relative mb-6 sm:mb-8">
          <div className="flex items-start justify-between mb-4">
            <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-gray-800 leading-tight flex-1 mr-2 sm:mr-4 break-words">
              {event.title}
            </h1>
        ...
        <div className="space-y-4 sm:space-y-6 mb-6 sm:mb-8">
          ...
          {/* Event Info Cards - Mobile Vertical, Desktop Side by Side */}
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
            {/* Organizer Card */}
